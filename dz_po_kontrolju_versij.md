...
<p style='color:red'> создаем конфликт</p>
...
Для того чтобы git игнорировал некоторые файлы, например такие как <p style='color:red'> создаем конфликт</p> картинки нам потребуется сдеть одно простое действие.
